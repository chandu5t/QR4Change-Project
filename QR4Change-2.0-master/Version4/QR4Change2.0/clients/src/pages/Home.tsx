...
const Home = memo(() => {
  ...
  useEffect(() => {
    ...
    const updateLocationFromCoords = async (latitude, longitude) => {
      try {
  ...
  useEffect(() => {
    ...
    console.log(`Home component rendered, count: ${renderCountRef.current}`);
  });

  useEffect(() => {
    if (scanning && scannerRef.current && !isScanningRef.current) {
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6 md:space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-base md:text-lg lg:text-xl text-muted-foreground max-w-3xl mx-auto">
              Scan QR codes every 1-2 km across your city. Auto-capture location, timestamp, and report issues instantly with AI-powered Verification.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <Button 
              ...
              onClick={handleScanAndReport}
              disabled={scanning}
            >
              <QrCode className="mr-2 h-4 w-4 md:h-5 md:w-5" />
              {scanning ? "Starting Scanner..." : "Scan & Report"}
            </Button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[1000] p-4">
          <div className="bg-white p-6 rounded-2xl shadow-2xl w-full max-w-md border border-teal-200">
            ...
            <p className="text-sm text-gray-600 text-center mt-2">
              {scanning ? "Point your camera at the QR code to scan." : "Initializing camera..."}
            </p>
            <Button
              onClick={() => {
      ...
      <section className="container mx-auto px-4 py-12 md:py-16">
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-3 md:space-y-4 mb-8 md:mb-12">
            <h2 className="text-2xl md:text-3xl font-bold">QR4Change Smart Features</h2>
            <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto">
              Advanced QR-triggered reporting with auto-capture and AI Verification
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              {[
                ...
                { step: "3", title: "AI Routing", desc: "Automatic Verification and department assignment", icon: TrendingUp },
          ...
          <CardContent className="p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                disabled={scanning}
              >
                {scanning ? "Starting Scanner..." : "Start Reporting"}
              </Button>
